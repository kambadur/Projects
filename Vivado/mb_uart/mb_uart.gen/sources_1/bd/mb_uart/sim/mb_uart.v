...
//Command     : generate_target mb_uart.bd
//Design      : mb_uart
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mb_uart,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mb_uart,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=4,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "mb_uart.hwdef" *) 
module mb_uart
  ...
  mb_uart_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > mb_uart microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  mb_uart_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_DMA6IQ microblaze_0_local_memory
  ...
  mb_uart_reset_inv_0_0 reset_inv_0
       (.Op1(reset),
        .Res(reset_inv_0_Res));
  mb_uart_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module microblaze_0_local_memory_imp_DMA6IQ
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > mb_uart microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  mb_uart_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  mb_uart_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  mb_uart_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
