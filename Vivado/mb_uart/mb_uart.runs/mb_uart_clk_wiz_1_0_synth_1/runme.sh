...
HD_PWD='/home/carbon/kambadur/Projects/Vivado/mb_uart/mb_uart.runs/mb_uart_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_uart_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_uart_clk_wiz_1_0.tcl
