...
HD_PWD='/home/carbon/kambadur/Projects/Vivado/mb_uart/mb_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_uart_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_uart_wrapper.tcl
