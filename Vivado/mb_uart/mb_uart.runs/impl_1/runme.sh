...
HD_PWD='/home/carbon/kambadur/Projects/Vivado/mb_uart/mb_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_uart_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_uart_wrapper.tcl -notrace
