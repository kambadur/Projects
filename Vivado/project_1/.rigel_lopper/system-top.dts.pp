#line 1 "../platform_hello_bram/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../platform_hello_bram/hw/sdt/zynq-7000.dtsi"
...
#line 1 "../platform_hello_bram/hw/sdt/pl.dtsi"
/ {
	amba_pl: amba_pl {
		ranges;
		compatible = "simple-bus";
		...
		axi_bram_ctrl_1: axi_bram_ctrl@80000000 {
			xlnx,protocol = "AXI4";
			xlnx,edk-special = "BRAM_CTRL";
			compatible = "xlnx,axi-bram-ctrl-4.1";
			xlnx,ecc-onoff-reset-value = <0>;
...
#line 1 "../platform_hello_bram/hw/sdt/pcw.dtsi"
	&ps7_cortexa9_0 {
		xlnx,rable = <0>;
...
#line 5 "../platform_hello_bram/hw/sdt/system-top.dts"
/ {
	board = "zedboard";
	...
	slrcount = <1>;
	family = "Zynq";
	axi_bram_ctrl_0_memory: memory@40000000 {
		compatible = "xlnx,axi-bram-ctrl-4.1";
		xlnx,ip-name = "axi_bram_ctrl";
		device_type = "memory";
		memory_type = "memory";
	...
	axi_bram_ctrl_1_memory: memory@80000000 {
		compatible = "xlnx,axi-bram-ctrl-4.1";
		xlnx,ip-name = "axi_bram_ctrl";
		device_type = "memory";
		memory_type = "memory";
	...
	cpus_a9: cpus-a9@0 {
		...
		address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
			      <0x40000000 &axi_bram_ctrl_0_memory 0x40000000 0x1000>,
			      <0x40000000 &axi_bram_ctrl_0 0x40000000 0x1000>,
			      <0x80000000 &axi_bram_ctrl_1_memory 0x80000000 0x1000>,
			      <0x80000000 &axi_bram_ctrl_1 0x80000000 0x1000>,
