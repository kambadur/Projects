...
module design_1
  ...
  wire myip_spi_controller_0_cmd_clear_start;
  wire myip_spi_controller_0_done;
  wire myip_spi_controller_0_sclk;
  ...
  design_1_myip_spi_controller_0_2 myip_spi_controller_0
       (.cmd_clear_start(myip_spi_controller_0_cmd_clear_start),
        .done(myip_spi_controller_0_done),
        ...
        .sclk(myip_spi_controller_0_sclk));
  ...
  design_1_system_ila_0_0 system_ila_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(myip_spi_controller_0_done),
        .probe1(myip_spi_controller_0_cmd_clear_start),
        .probe2(myip_spi_controller_0_sclk),
        .probe3(rst_ps7_0_100M_peripheral_aresetn));
  design_1_xlconcat_0_0 xlconcat_0
       (.In0(myip_spi_controller_0_done),
        .In1(myip_spi_controller_0_cmd_clear_start),
