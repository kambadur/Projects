...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_bram_cntlr_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]axi_smc_1_M01_AXI_ARADDR;
  wire [1:0]axi_smc_1_M01_AXI_ARBURST;
  wire [3:0]axi_smc_1_M01_AXI_ARCACHE;
  wire [3:0]axi_smc_1_M01_AXI_ARLEN;
  wire [1:0]axi_smc_1_M01_AXI_ARLOCK;
  ...
  wire [31:0]axi_smc_1_M01_AXI_AWADDR;
  wire [1:0]axi_smc_1_M01_AXI_AWBURST;
  wire [3:0]axi_smc_1_M01_AXI_AWCACHE;
  wire [3:0]axi_smc_1_M01_AXI_AWLEN;
  wire [1:0]axi_smc_1_M01_AXI_AWLOCK;
  ...
  (* BMM_INFO_PROCESSOR = "arm > design_1 axi_bram_ctrl_1" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        ...
        .S_AXI_HP0_ARADDR(axi_smc_1_M01_AXI_ARADDR),
        .S_AXI_HP0_ARBURST(axi_smc_1_M01_AXI_ARBURST),
        .S_AXI_HP0_ARCACHE(axi_smc_1_M01_AXI_ARCACHE),
        .S_AXI_HP0_ARID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_ARLEN(axi_smc_1_M01_AXI_ARLEN),
        .S_AXI_HP0_ARLOCK(axi_smc_1_M01_AXI_ARLOCK),
        .S_AXI_HP0_ARPROT(axi_smc_1_M01_AXI_ARPROT),
        .S_AXI_HP0_ARQOS(axi_smc_1_M01_AXI_ARQOS),
        .S_AXI_HP0_ARREADY(axi_smc_1_M01_AXI_ARREADY),
        .S_AXI_HP0_ARSIZE(axi_smc_1_M01_AXI_ARSIZE),
        .S_AXI_HP0_ARVALID(axi_smc_1_M01_AXI_ARVALID),
        .S_AXI_HP0_AWADDR(axi_smc_1_M01_AXI_AWADDR),
        .S_AXI_HP0_AWBURST(axi_smc_1_M01_AXI_AWBURST),
        .S_AXI_HP0_AWCACHE(axi_smc_1_M01_AXI_AWCACHE),
        .S_AXI_HP0_AWID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_AWLEN(axi_smc_1_M01_AXI_AWLEN),
        .S_AXI_HP0_AWLOCK(axi_smc_1_M01_AXI_AWLOCK),
        .S_AXI_HP0_AWPROT(axi_smc_1_M01_AXI_AWPROT),
        .S_AXI_HP0_AWQOS(axi_smc_1_M01_AXI_AWQOS),
        .S_AXI_HP0_AWREADY(axi_smc_1_M01_AXI_AWREADY),
        .S_AXI_HP0_AWSIZE(axi_smc_1_M01_AXI_AWSIZE),
        .S_AXI_HP0_AWVALID(axi_smc_1_M01_AXI_AWVALID),
        .S_AXI_HP0_BREADY(axi_smc_1_M01_AXI_BREADY),
        .S_AXI_HP0_BRESP(axi_smc_1_M01_AXI_BRESP),
        .S_AXI_HP0_BVALID(axi_smc_1_M01_AXI_BVALID),
        .S_AXI_HP0_RDATA(axi_smc_1_M01_AXI_RDATA),
        .S_AXI_HP0_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP0_RLAST(axi_smc_1_M01_AXI_RLAST),
        .S_AXI_HP0_RREADY(axi_smc_1_M01_AXI_RREADY),
        .S_AXI_HP0_RRESP(axi_smc_1_M01_AXI_RRESP),
        .S_AXI_HP0_RVALID(axi_smc_1_M01_AXI_RVALID),
        .S_AXI_HP0_WDATA(axi_smc_1_M01_AXI_WDATA),
        .S_AXI_HP0_WID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_WLAST(axi_smc_1_M01_AXI_WLAST),
        .S_AXI_HP0_WREADY(axi_smc_1_M01_AXI_WREADY),
        .S_AXI_HP0_WRISSUECAP1_EN(1'b0),
        .S_AXI_HP0_WSTRB(axi_smc_1_M01_AXI_WSTRB),
        .S_AXI_HP0_WVALID(axi_smc_1_M01_AXI_WVALID),
