#line 1 "../zynq_nand_axi_gpio/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../zynq_nand_axi_gpio/hw/sdt/zynq-7000.dtsi"
...
#line 1 "../zynq_nand_axi_gpio/hw/sdt/pl.dtsi"
/ {
	amba_pl: amba_pl {
		ranges;
		compatible = "simple-bus";
		#address-cells = <1>;
		#size-cells = <1>;
		firmware-name = "zynq_axi_gpio_wrapper.bit.bin";
		clocking0: clocking0 {
...
#line 1 "../zynq_nand_axi_gpio/hw/sdt/pcw.dtsi"
	&ps7_cortexa9_0 {
		xlnx,rable = <0>;
...
#line 5 "../zynq_nand_axi_gpio/hw/sdt/system-top.dts"
/ {
	board = "zedboard";
