...
HD_PWD='/home/carbon/kambadur/Projects/Vivado/zed_nand_axi_gpio/zed_nand_axi_gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_gpio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_gpio_wrapper.tcl
