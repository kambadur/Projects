...
HD_PWD='/home/carbon/kambadur/Projects/Vivado/zed_nand_axi_gpio/zed_nand_axi_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_axi_gpio_wrapper.tcl -notrace
